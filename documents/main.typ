...
When considering which metrics to focus on in the context of machine learning, we must examine how to extract meaniningful mathematical representations of these features.
